...
<div class="ras-color-picker">
  ...
  <div class="ras-color-picker-row">
    <div class="ras-color-picker-pipette">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 296.135 296.135" style="enable-background:new 0 0 296.135 296.135;" xml:space="preserve">
  ...
  <div class="ras-color-picker-alpha-box">
    <div class="ras-color-picker-line ras-color-picker-control-area ras-color-picker-alpha-line ras-color-picker-alpha-bg" style="display: flex;">
